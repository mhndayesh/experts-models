# dnfile — source for FactBank extraction (target version 0.15)

Source: https://github.com/malwarefrank/dnfile — HISTORY.rst (changelog) + README.rst (API usage).
No GitHub Releases exist for this repo (releases API returned 0). Tags run v0.5.0 .. v0.18.0; changelog is HISTORY.rst.

dnfile is a pure-Python parser for .NET (CLR) executables, extending the pefile library (dnPE subclasses pefile.PE).
...
======================================================================
## README.rst (API usage / object model)
======================================================================
