# Responder v3 Changelog Source (Responder / lgandx)

Compiled verbatim from:
- https://raw.githubusercontent.com/lgandx/Responder/master/CHANGELOG.md  (full project CHANGELOG, keepachangelog format, Unreleased + v3.1.4.0 down to v2.x)

Notes:
- GitHub Releases API returned an empty array (no published release bodies); tags exist (v3.2.2.0 ... v3.0.0.0 ...) but carry no changelog body, so the CHANGELOG.md below is the authoritative source.
- Defensive / authorized-testing framing: extract config-option and default-value correctness facts only (what option exists, what its default is, what changed), NOT attack how-to.

======================================================================
## VERBATIM CHANGELOG.md (master)
======================================================================
