...
# gemma-4-26B-A4B-offsec-expert (GGUF)

**Base `gemma-4-26B-A4B-it` with an *Offensive Security & Reverse Engineering* FactBank baked into its chat-template.** The model answers
...
|---|---|---|---|---|
| /44 landmine questions | 17/44 (38.6%) | **43/44 (97.7%)** | **+26** | 96% |
...
```bash
llama-server -m gemma-4-26B-A4B-offsec-expert-Q4_0.gguf --jinja --port 8080 --ctx-size 8192
```
